<x-app>
    ...
    <div class="p-4 border-2 border-gray-200 bg-blue-300  rounded-lg dark:border-gray-700 mt-14">
        <span class="text-3xl font-semibold">Halaman Users</span>
    </div>
    ...
    @if ($message = Session::get('success'))
     ...
     <div class="p-4 border-2 border-gray-200 bg-gray-50 rounded-lg dark:border-gray-700 mt-8 mb-4">
        <div class="flex flex-col sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between">
            <div class="">
                <a href="{{ route('user.create') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-2xl text-sm px-5 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create</a>
            </div>
            <form action="{{ route('user.index') }}" method="GET" class="flex items-center space-x-3">
